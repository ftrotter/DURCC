...
class ZZermeloIndexGenerator extends \ftrotter\DURCC\DURCCGenerator {
...
?>";
	...
	$signed_zzermelo_report = Signature::sign_phpfile_string($report_php_code);
	...
	if(file_exists($report_file_location)){
		//do nothing for now..
				...
				file_put_contents($report_file_location,$signed_zzermelo_report);
                        }
