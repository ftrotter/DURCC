...
class LaravelTestRouteGenerator extends \ftrotter\DURCCC\DURCCGenerator {
...
/*
	...
	IF you would like to quickly see and test all of the index routes that are generated by DURCC
...
//This closure lists all of the index routes that DURCC knows about...
...
";
	...
	\$html = '<html><head><title>DURCC Test Page</title><body><h1>DURCC Test Page</h1><h3>DO NOT USE IN PRODUCTION!!!</h3>';
	...
	\$html .= '</ul></body></html>';
	return \$html;
}); //end DURCC test route closure

Route::get('/',function () {
	\$test_data = ['content' => '<h1>This is test content</h1>'];
	return view('DURCC.durc_html',\$test_data);
});
";
